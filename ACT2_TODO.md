...
shares zone-aware terrain sampling and terrain-settling across zones, aligns the visible rim with the
playable radius (`walkR`), and gives mid-map mesas real circular blockers.
